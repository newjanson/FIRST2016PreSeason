...
public class OI {
    ...
    public OI() {
        ...
        JoystickButton elevator4 = new JoystickButton(operator, 4);
        elevator4.whileHeld(new elevator4());
        JoystickButton elevatorReset = new JoystickButton(operator, 10);
        ...
        SmartDashboard.putData("elevator4", new elevator4());
        SmartDashboard.putData("elevatorReset", new elevatorReset());

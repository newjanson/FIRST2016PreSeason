...
public class OI {
    ...
    public OI() {
        ...
        doRollersOut = new JoystickButton(driverPad, 7);
        doRollersOut.whileHeld(new rollerOut());
        doRollersIn = new JoystickButton(driverPad, 8);
        doRollersIn.whileHeld(new rollerIn());
        doRollersIn.whenReleased(new rollerStop());
        doRollersOut.whenReleased(new rollerStop());
        
        openBottomGripper = new JoystickButton(driverPad, 5);        
        closeBottomGripper = new JoystickButton(driverPad, 6);
        ...
        SmartDashboard.putData("driveAngleTurn", new driveAngleTurn());
